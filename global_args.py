...
def add_args(ap: argparse.ArgumentParser):
    ap.add_argument("--plan", action='store_true', help="Min comparison value")
    ...
    ap.add_argument("-p", "--processes", required=False, default=int(os.cpu_count() / 4) + 1, type=int, help="Max processes")
